...
// =============================================================================
// LEGACY ANDROID BRIDGE TYPES (generation 1)
//
// The live Android bridge - src/utils/androidBridgeEngine.ts, its adapter, the
// permission centre and App.tsx - was written against this type family. The
// newer Mobile* family above is a separate, disjoint set of names (no symbol is
// shared between the two), so both are exported here to keep the bridge
// typechecking until the two generations are consolidated.
// =============================================================================
